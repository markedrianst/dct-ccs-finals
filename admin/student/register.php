    ...
    <div class="card">
        <div class="card-body">
            <form action="" method="POST">
                ...
                <input type="text" class="form-control" id="studentId" name="studentId" placeholder="Enter Student ID"  value="<?php echo isset($_POST['studentId']) ? htmlspecialchars($_POST['studentId']) : ''; ?>">
